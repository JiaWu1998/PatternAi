...
// all nudgeDirection for low-mid level | total 193  => index 1
...
const backProp = (thisIterationAgain) => {
    ...
    let targetFilters = []; // ordered of neuron[1]
...
// I need to change the nudgeDirection because it is randomly generated or randomly guessed for the first set
// Now, I need to make it generic so that it knows that which way to move is the best way for 193 + 2 COMPONENTS!!!
// this would probably be implemented in the backProp();